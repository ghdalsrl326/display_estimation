...
headers = {'trials','ref_x','ref_y','ref_z','best_x','best_y','best_z','best_w','best_s','best_distance_error','best_direction_error','t1_x','t1_y','t1_z','t1_w','t1_s','t1_distance_error','t1_direction_error','t2_x','t2_y','t2_z','t2_w','t2_s','t2_distance_error','t2_direction_error','t3_x','t3_y','t3_z','t3_w','t3_s','t3_distance_error','t3_direction_error','t4_x','t4_y','t4_z','t4_w','t4_s','t4_distance_error','t4_direction_error','dummy'};
for s = 1:10
    inst_1(s).R1 = readtable(strcat('../../dataset/user_test_case1_bo/',string(s),'/data_robot_1_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_1(s).C = readtable(strcat('../../dataset/user_test_case1_bo/',string(s),'/data_robot_2_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');    
    inst_1(s).L1 = readtable(strcat('../../dataset/user_test_case1_bo/',string(s),'/data_robot_3_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_1(s).L2 = readtable(strcat('../../dataset/user_test_case1_bo/',string(s),'/data_robot_4_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_1(s).R2 = readtable(strcat('../../dataset/user_test_case1_bo/',string(s),'/data_robot_5_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');    

    inst_1(s).R1.Properties.VariableNames = headers;
    inst_1(s).C.Properties.VariableNames = headers;
    inst_1(s).L1.Properties.VariableNames = headers;
    inst_1(s).L1.Properties.VariableNames = headers;
    inst_1(s).R2.Properties.VariableNames = headers;
end
inst_1;

%% IMOPORT RESULTS AS STRUCT: INSTRUCTION CASE 2
for s = 1:10
    inst_2(s).R1 = readtable(strcat('../../dataset/user_test_case2_bo/',string(s),'/data_robot_1_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_2(s).C = readtable(strcat('../../dataset/user_test_case2_bo/',string(s),'/data_robot_2_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_2(s).L1 = readtable(strcat('../../dataset/user_test_case2_bo/',string(s),'/data_robot_3_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_2(s).L2 = readtable(strcat('../../dataset/user_test_case2_bo/',string(s),'/data_robot_4_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_2(s).R2 = readtable(strcat('../../dataset/user_test_case2_bo/',string(s),'/data_robot_5_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');

    inst_2(s).R1.Properties.VariableNames = headers;
    inst_2(s).C.Properties.VariableNames = headers;
    inst_2(s).L1.Properties.VariableNames = headers;
    inst_2(s).L1.Properties.VariableNames = headers;
    inst_2(s).R2.Properties.VariableNames = headers;
end
inst_2;

%% IMOPORT RESULTS AS STRUCT: INSTRUCTION CASE 3
for s = 1:10
    inst_3(s).R1 = readtable(strcat('../../dataset/user_test_case3_bo/',string(s),'/data_robot_1_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_3(s).C = readtable(strcat('../../dataset/user_test_case3_bo/',string(s),'/data_robot_2_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_3(s).L1 = readtable(strcat('../../dataset/user_test_case3_bo/',string(s),'/data_robot_3_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_3(s).L2 = readtable(strcat('../../dataset/user_test_case3_bo/',string(s),'/data_robot_4_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_3(s).R2 = readtable(strcat('../../dataset/user_test_case3_bo/',string(s),'/data_robot_5_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');

    inst_3(s).R1.Properties.VariableNames = headers;
    inst_3(s).C.Properties.VariableNames = headers;
    inst_3(s).L1.Properties.VariableNames = headers;
    inst_3(s).L1.Properties.VariableNames = headers;
    inst_3(s).R2.Properties.VariableNames = headers;
end
inst_3;

%% IMOPORT RESULTS AS STRUCT: INSTRUCTION CASE 4
for s = 1:10
    inst_4(s).R1 = readtable(strcat('../../dataset/user_test_case4_bo/',string(s),'/data_robot_1_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_4(s).C = readtable(strcat('../../dataset/user_test_case4_bo/',string(s),'/data_robot_2_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_4(s).L1 = readtable(strcat('../../dataset/user_test_case4_bo/',string(s),'/data_robot_3_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_4(s).L2 = readtable(strcat('../../dataset/user_test_case4_bo/',string(s),'/data_robot_4_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');
    inst_4(s).R2 = readtable(strcat('../../dataset/user_test_case4_bo/',string(s),'/data_robot_5_bayes_rawgaze'),'ReadVariableNames',true,'HeaderLines',0,'Format','auto');

    inst_4(s).R1.Properties.VariableNames = headers;
    inst_4(s).C.Properties.VariableNames = headers;
    inst_4(s).L1.Properties.VariableNames = headers;
    inst_4(s).L1.Properties.VariableNames = headers;
    inst_4(s).R2.Properties.VariableNames = headers;    
end
inst_4;
