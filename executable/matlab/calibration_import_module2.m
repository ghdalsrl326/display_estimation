function [head_origin, head_direction, eye_origin, gaze_vector] = calibration_import_module2(raw_data)
...
gaze_vector = [(raw_data.gaze_0_x + raw_data.gaze_1_x), (raw_data.gaze_0_y + raw_data.gaze_1_y -0.26), (raw_data.gaze_0_z + raw_data.gaze_1_z)].*(350); % cam coord
