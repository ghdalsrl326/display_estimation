function [W, sphere_center] = personal_calibration_matrix()
...
%% 구 생성
[N, R0] = tangent_plane(sphere_center, norm(sphere_center), deg2rad(-90),deg2rad(0));
hold on
grid on
...
B = [az_cal_vect_LT_1, el_cal_vect_LT_1, az_cal_vect_LD_3, el_cal_vect_LD_3]';
