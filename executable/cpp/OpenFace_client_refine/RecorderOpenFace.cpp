...
std::string RecorderOpenFace::WriteObservation(bool check)
{
	...
	bool IsDebug = false;
	if (IsDebug) {
		ret = std::string("relevant_entry:") + "{"
			+ "'face_id': " + std::to_string(face_id) + ", "
			+ "'frame_number': " + std::to_string(frame_number) + ", "
			+ "'landmark_detection_success': " + std::to_string(landmark_detection_success) + ", "
			+ "'landmark_detection_confidence': " + std::to_string(landmark_detection_confidence) + ", "
			+ "'gaze_direction_0_x': " + std::to_string(gaze_direction0.x) + ", "
			+ "'gaze_direction_0_y': " + std::to_string(gaze_direction0.y) + ", "
			+ "'gaze_direction_0_z': " + std::to_string(gaze_direction0.z) + ", "
			+ "'gaze_direction_1_x': " + std::to_string(gaze_direction1.x) + ", "
			+ "'gaze_direction_1_y': " + std::to_string(gaze_direction1.y) + ", "
			+ "'gaze_direction_1_z': " + std::to_string(gaze_direction1.z) + ", "
			+ "'gaze_angle_x': " + std::to_string(gaze_angle[0]) + ", "
			+ "'gaze_angle_y': " + std::to_string(gaze_angle[1]) + ", "
			+ "'pose_Tx': " + std::to_string(head_pose[0]) + ", "
			+ "'pose_Ty': " + std::to_string(head_pose[1]) + ", "
			+ "'pose_Tz': " + std::to_string(head_pose[2]) + ", "
			+ "'pose_Rx': " + std::to_string(head_pose[3]) + ", "
			+ "'pose_Ry': " + std::to_string(head_pose[4]) + ", "
			+ "'pose_Rz': " + std::to_string(head_pose[5]) + ", ";
	}
	else {
		ret = std::to_string(face_id) + ", "
			+ std::to_string(frame_number) + ", "
			+ std::to_string(landmark_detection_success) + ", "
			+ std::to_string(landmark_detection_confidence) + ", "
			+ std::to_string(gaze_direction0.x) + ", "
			+ std::to_string(gaze_direction0.y) + ", "
			+ std::to_string(gaze_direction0.z) + ", "
			+ std::to_string(gaze_direction1.x) + ", "
			+ std::to_string(gaze_direction1.y) + ", "
			+ std::to_string(gaze_direction1.z) + ", "
			+ std::to_string(gaze_angle[0]) + ", "
			+ std::to_string(gaze_angle[1]) + ", "
			+ std::to_string(head_pose[0]) + ", "
			+ std::to_string(head_pose[1]) + ", "
			+ std::to_string(head_pose[2]) + ", "
			+ std::to_string(head_pose[3]) + ", "
			+ std::to_string(head_pose[4]) + ", "
			+ std::to_string(head_pose[5]) + ", ";
	}
